...
class TradeRequestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trade_request" do
    assert_difference('TradeRequest.count') do
      post trade_requests_url, params: { trade_request: { date: @trade_request.date, name: @trade_request.name } }
    end
  ...
  test "should update trade_request" do
    patch trade_request_url(@trade_request), params: { trade_request: { date: @trade_request.date, name: @trade_request.name } }
